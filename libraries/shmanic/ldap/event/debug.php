 ...
 * @since       2.0
 */
class SHLdapEventDebug extends Event
{
	/**
	...
	{
		SHLog::add(
			Text::sprintf('LIB_SHLDAPEVENTDEBUG_CALLED', __METHOD__), 11901, Log::DEBUG, 'ldap'
		);
	}
	...
	{
		SHLog::add(
			Text::sprintf('LIB_SHLDAPEVENTDEBUG_CALLED', __METHOD__), 11902, Log::DEBUG, 'ldap'
		);
	}
	...
	{
		SHLog::add(
			Text::sprintf('LIB_SHLDAPEVENTDEBUG_CALLED', __METHOD__), 11903, Log::DEBUG, 'ldap'
		);
	}
	...
	{
		SHLog::add(
			Text::sprintf('LIB_SHLDAPEVENTDEBUG_CALLED', __METHOD__), 11904, Log::DEBUG, 'ldap'
		);
	...
	{
		SHLog::add(
			Text::sprintf('LIB_SHLDAPEVENTDEBUG_CALLED', __METHOD__), 11905, Log::DEBUG, 'ldap'
		);
	}
	...
	{
		SHLog::add(
			Text::sprintf('LIB_SHLDAPEVENTDEBUG_CALLED', __METHOD__), 11906, Log::DEBUG, 'ldap'
		);
	}
	...
	{
		SHLog::add(
			Text::sprintf('LIB_SHLDAPEVENTDEBUG_CALLED', __METHOD__), 11907, Log::DEBUG, 'ldap'
		);
	}
	...
	{
		SHLog::add(
			Text::sprintf('LIB_SHLDAPEVENTDEBUG_CALLED', __METHOD__), 11908, Log::DEBUG, 'ldap'
		);
	}
	...
	{
		SHLog::add(
			Text::sprintf('LIB_SHLDAPEVENTDEBUG_CALLED', __METHOD__), 11909, Log::DEBUG, 'ldap'
		);
	}
	...
	{
		SHLog::add(
			Text::sprintf('LIB_SHLDAPEVENTDEBUG_CALLED', __METHOD__), 11910, Log::DEBUG, 'ldap'
		);
	}
}
